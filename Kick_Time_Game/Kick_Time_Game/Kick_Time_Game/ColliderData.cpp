...
const ColliderData colliderDataArray[NUMBER_COLLIDERDATA] =
{
	...
	ColliderData(COLLIDER_SCORPION_BACKWARD_JUMP_RIGHT, 36, 100, 22, 30),
	ColliderData(COLLIDER_SCORPION_GUARD_RIGHT, 36, 70, 22, 70),
	ColliderData(COLLIDER_SCORPION_GUARD_ON_RIGHT, 36, 70, 22, 70),
	ColliderData(COLLIDER_SCORPION_LOW_GUARD_RIGHT, 36, 40, 22, 30),
	ColliderData(COLLIDER_SCORPION_LOW_GUARD_ON_RIGHT, 36, 40, 22, 30),
	...
	ColliderData(COLLIDER_SCORPION_BACKWARD_JUMP_LEFT, 36, 100, 22, 30),
	ColliderData(COLLIDER_SCORPION_GUARD_LEFT, 36, 70, 22, 70),
	ColliderData(COLLIDER_SCORPION_GUARD_ON_LEFT, 36, 70, 22, 70),
	ColliderData(COLLIDER_SCORPION_LOW_GUARD_LEFT, 36, 40, 22, 30),
	ColliderData(COLLIDER_SCORPION_LOW_GUARD_ON_LEFT, 36, 40, 22, 30),

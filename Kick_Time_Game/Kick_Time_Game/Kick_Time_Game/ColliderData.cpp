...
const ColliderData colliderDataArray[NUMBER_COLLIDERDATA] =
{
	...
	ColliderData(COLLIDER_SCORPION_KICK_PUNCH, 100, 105, 10, 8),
	ColliderData(COLLIDER_SCORPION_KICK_PUNCH_UP, 100, 85, 10, 8),
	ColliderData(COLLIDER_SCORPION_KICK_PUNCH_DOWN, 100, 40, 10, 8),
};

...
const AnimationData animationDataArray[NUMBER_ANIMATIONDATA] =
{
	...
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_GUARD_RIGHT, 0, 1166, 67, 140, 6, 3, true, COLLIDER_SCORPION_GUARD_RIGHT, COLLIDER_NULL),
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_LOW_GUARD_RIGHT, 0, 1326, 69, 87, 6, 3, true, COLLIDER_SCORPION_LOW_GUARD_RIGHT, COLLIDER_NULL),
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_PUNCH_RIGHT, 0, 1444, 143, 143, 6, 9, false, COLLIDER_SCORPION_PUNCH_RIGHT, COLLIDER_SCORPION_KICK_PUNCH),
	...
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_GUARD_LEFT, 1912, 1166, -67, 140, 6, 3, true, COLLIDER_SCORPION_GUARD_LEFT, COLLIDER_NULL),
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_LOW_GUARD_LEFT, 1912, 1326, -69, 97, 6, 3, true, COLLIDER_SCORPION_LOW_GUARD_LEFT, COLLIDER_NULL),
	AnimationData("../Ressources/Characters/MK/Scorpion/Scorpion.png", SCORPION_PUNCH_LEFT, 1912, 1445, -143, 143, 6, 9, false, COLLIDER_SCORPION_PUNCH_LEFT, COLLIDER_SCORPION_KICK_PUNCH),

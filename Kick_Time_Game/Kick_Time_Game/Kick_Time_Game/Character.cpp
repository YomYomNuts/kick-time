...
Character::Character(void)
{
	...
	this->posCharacterX = SCREEN_SIZE_WIDTH / 2 - 25;
	this->posCharacterY = SCREEN_SIZE_HEIGHT / 2 + 75;
}
...
void Character::renderCharacter()
{
	...
	this->spriteCharacter->setPosition(this->posCharacterX,this->posCharacterY);
